...
class RoundSystem(models.Model):
	...
	content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, limit_choices_to=CHOICES_ROUND_SYSTEM_TYPE)
	object_id = models.PositiveIntegerField()
	system = GenericForeignKey('content_type', 'object_id')

class RoundSystemTypeSemiLinear(models.Model):

    round_system = GenericRelation(RoundSystem)
